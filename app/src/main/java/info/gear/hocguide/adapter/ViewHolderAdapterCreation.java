...
public class ViewHolderAdapterCreation extends info.gear.hocguide.ViewHolderAdapter2 {
    ...
    public ViewHolderAdapterCreation(Activity context,String[] web,Carta[] carte,boolean lingua)
    {
        super(context, carte, lingua);
        this.lingua=lingua;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.imageView.setTag(selezionata);
